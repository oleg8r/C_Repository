...
| Documentation: This program is for array manipulation.The program is
|	completely modular and has a menu, where separate
...
{  
    int var1, var2;  
    for (var1 = 0; var1 < size - 1; var1++)      
        for (var2 = 0; var2 < size - var1 - 1; var2++)  
